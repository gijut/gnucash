...
static const guint32 reg_colors_reverse_video [] =
{
    ...
    0x000040,     // COLOR_HEADER_BG
    0x004000,     // COLOR_PRIMARY_BG
    0x004040,     // COLOR_PRIMARY_BG_ACTIVE
    0x400000,     // COLOR_SECONDARY_BG
    0x400040,     // COLOR_SECONDARY_BG_ACTIVE
    0x404000,     // COLOR_SPLIT_BG
    0x404040,     // COLOR_SPLIT_BG_ACTIVE

    0xFFBFFF,     // COLOR_UNKNOWN_FG
    0xBFBFFF,     // COLOR_HEADER_FG
    0xFFFFFF,     // COLOR_PRIMARY_FG
    0xFFFFBF,     // COLOR_PRIMARY_FG_ACTIVE
    0xBFFFFF,     // COLOR_SECONDARY_FG
    0xBFFFBF,     // COLOR_SECONDARY_FG_ACTIVE
    0xFFFFFF,     // COLOR_SPLIT_FG
    0xFFFFBF,     // COLOR_SPLIT_FG_ACTIVE
