...
static const guint32 reg_colors_reverse_video [] =
{
    ...
    0xFFFFBF,     // COLOR_HEADER_BG
    0xFFBFFF,     // COLOR_PRIMARY_BG
    0xFFBFBF,     // COLOR_PRIMARY_BG_ACTIVE
    0xBFFFFF,     // COLOR_SECONDARY_BG
    0xBFFFBF,     // COLOR_SECONDARY_BG_ACTIVE
    0xBFBFFF,     // COLOR_SPLIT_BG
    0xBFBFBF,     // COLOR_SPLIT_BG_ACTIVE

    0x005000,     // COLOR_UNKNOWN_FG
    0x505000,     // COLOR_HEADER_FG
    0x000000,     // COLOR_PRIMARY_FG
    0x000050,     // COLOR_PRIMARY_FG_ACTIVE
    0x500000,     // COLOR_SECONDARY_FG
    0x500050,     // COLOR_SECONDARY_FG_ACTIVE
    0x000000,     // COLOR_SPLIT_FG
    0x505050,     // COLOR_SPLIT_FG_ACTIVE
